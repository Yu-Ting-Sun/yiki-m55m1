...
int BoardInit(void)
{
    ...
    /* Earliest possible boot marker: if a (button-)reset shows NOTHING at
     * all, the hang is before this line (clock/UART/boot-select); if this
     * line appears but "Set DLL Delay Num" doesn't, the HyperRAM warm-reset
     * trim below is the culprit. */
    printf("\n[BOOT] BoardInit begin\n");
